    ...
    return (
        <div className="h-screen bg-cyan-100 overflow-hidden relative">
           ...
           <div className='container h-screen flex items-center justify-center px-20 mx-auto'>
            <div className='w-[30rem] h-[80vh] flex items-end bg-signup-bg-img bg-cover bg-center rounded-lg p-10 z-50'>
                <div>
            ...
            <div className='w-[30rem] h-[65vh] bg-white rounded-r-lg relative p-16 shadow-lg shadow-cyan-200/20'>
