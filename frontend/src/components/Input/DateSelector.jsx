...
const DateSelector=({date,setDate})=>{
    ...
    return(
        <div>
            <button 
            className="inline-flex items-center gap-2 text-[13px] font-medium text-sky-500 bg-cyan-50 hover:bg-cyan-400  hover:text-white  rounded px-2 py-1 cursor-pointer"
             onClick={()=>{
